...
namespace autoware::motion_velocity_planner::trailer_pedestrian_stop::debug
{
...
std::vector<visualization_msgs::msg::Marker> make_polygon_markers(
  ...
  const float r, const float g, const float b, const double line_width)
{
  std::vector<visualization_msgs::msg::Marker> markers;
  visualization_msgs::msg::Marker marker;
  marker.header.frame_id = "map";
  ...
  marker.action = visualization_msgs::msg::Marker::ADD;
  marker.scale = autoware_utils::create_marker_scale(line_width, line_width, line_width);
